...
CREATE TABLE Operation_Log (
    ...
    operation_message VARCHAR2(255),
    operation_timestamp TIMESTAMP DEFAULT SYSDATE
);

CREATE TABLE Summary_Report (
    report_id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    period_type VARCHAR2(10) CHECK (period_type IN ('month', 'quarter', 'year')),
    period_start DATE,
    period_end DATE,
